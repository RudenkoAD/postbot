...
class VKFetchingWorker:
    ...
    def __init__(self, pulling_tasks_queue, sleep_time, vk_fetcher: VKFetcher, default_sending_topic):
    ...
    def start(self):
        log.debug(f"Starting VKFetchingWorker with sleep_time: {self.__sleep_time},sending_topic: {self.__default_sending_topic}")
